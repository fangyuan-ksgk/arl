...
# memory between runs). All use the colocate vLLM engine — tree sampling
# requires it, and we keep the others colocate too for an apples-to-apples
# rollout path.
#
...
echo "  train_gpu    = ${TRAIN_GPU}    vllm_mem = ${VLLM_MEM}"
